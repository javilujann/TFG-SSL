...
Se expone a continuación un algoritmo de auto-entrenamiento donde se pueden observar estas decisiones de diseño:
...
Los dos primeros términos corresponden a la minimización del riesgo regularizado estándar de cada clasificador sobre los datos etiquetados. El tercer término es el aporte propio de la co-regularización: penaliza las discrepancias entre las predicciones de los distintos clasificadores sobre los datos no etiquetados, ponderadas por el hiperparámetro $\gamma > 0$. De esta manera, los datos no etiquetados actúan como un puente que fuerza el acuerdo entre los clasificadores, transfiriendo información entre ellos de forma implícita.
