...
Un posible enfoque es el propuesto por \citet{pmlr-v5-goldberg09a}, que se basa en la idea de que los datos pueden estar distribuidos en diferentes subespacios, y que cada uno de estos subespacios puede ser modelado por un algoritmo de \textit{clustering} diferente. En este enfoque, se aplica un algoritmo de \textit{clustering} no supervisado para identificar estos subespacios, y luego se entrena un modelo supervisado para cada subespacio utilizando solo las muestras etiquetadas que pertenecen a dicha variedad. De esta forma, se obtiene un conjunto de modelos supervisados especializados en cada subespacio, lo que puede mejorar el rendimiento del modelo global.
