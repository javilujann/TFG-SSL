...
O el de \textit{Semi-Supervised Clustering Using Genetic Algorithms, Demiriz et al., 1999} \cite{demiriz1999semi} donde se utiliza un algoritmo de clustering semi-supervisado que combina tanto la información de los datos no etiquetados como la información de las muestras etiquetadas para realizar la partición del espacio.
