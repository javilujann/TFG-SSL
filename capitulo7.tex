...
Atendiendo a la formulación de la Ecuación \ref{eq:minimizacionGrafos}, este método puede verse como la elección de una pérdida supervisada con peso infinito (equivalentem a imponer como restricciones las etiquetas en $L$) junto con un término de suavidad cuadrático en el grafo. Una posible formulación es:
