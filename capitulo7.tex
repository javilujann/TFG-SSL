...
El nombre proviene de la conexión con las funciones armónicas, puesto que la solución satisface una condición de \emph{media ponderada} sobre el grafo. En particular, para cada nodo no etiquetado $i\in U$ se cumple \cite{van2020survey}:
\begin{equation}
