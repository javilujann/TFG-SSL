...
Además, se ha añadido un pequeño cambio dentro de los métodos envolventes, se ha renombrado co-training por \textit{métodos basados en desacuerdo}. De esta manera, se evita nombrar a la familia por un algoritmo en concreto dentro de esta. El nuevo nombre refleja la idea general de esta familia de métodos tal y como se presenta en el trabajo de \citet{zhou2010semi}.
