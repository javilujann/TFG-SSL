...
Finalmente, los métodos basados en variedades constituyen una categoría independiente en la presente taxonomía. Por un lado, no pueden considerarse generativos, puesto que no modelan explícitamente el proceso de generación de los datos. Por otro lado, aunque al igual que los métodos discriminativos se centran en aprender directamente el modelo de clasificación, su enfoque subyacente es diferente al de las técnicas de máximo margen o de perturbaciones.
