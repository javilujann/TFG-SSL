...
Hay varias formas de definir la vecindad y/o la similitud. Por ejemplo, puede construirse un grafo de $k$ vecinos más cercanos y asignar pesos gaussianos $w_{ij} = \exp\bigl(-\frac{\|\mathbf{x}_i - \mathbf{x}_j\|^2}{2\sigma^2}\bigr)$ a las aristas \cite{zhu2009introduction}.
